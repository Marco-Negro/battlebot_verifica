...
# ═══════════════════════════════════════════════════════════════════
# GHOST_1 — ALLEATO / ESCA
# Ascolta sulla porta 9001
# Comportamento:
...
class SyncListener:
    ...
    def _start(self):
        def _server():
            ...
            srv.listen(1)
            print(f"[SYNC] 👂 Ghost_1 in ascolto su porta {self.port}...")
            conn, _ = srv.accept()
    ...
    def should_be_visible(self):
        """Controlla se c'è un segnale FIRE pendente e lo consuma."""
...
def ally_loop(api, state, sync):
    ...
    while True:
        ...
        # ── Visibile SOLO se arriva segnale FIRE ─────────────────
